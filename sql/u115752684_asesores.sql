...
`idtiposolicitud` int(11) NOT NULL,
  `tiposolicitud` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `tbentidadnacimiento`
MODIFY `identidadnacimiento` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbpromotorestados`
MODIFY `idpromotorestado` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbrolhogar`
MODIFY `idrolhogar` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbtipopromotores`
MODIFY `idtipopromotor` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tbtiposolicitudes`
--
ALTER TABLE `tbtiposolicitudes`
MODIFY `idtiposolicitud` int(11) NOT NULL AUTO_INCREMENT;
--
