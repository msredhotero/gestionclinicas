...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-10-2019 a las 21:33:30
...
--
-- Estructura de tabla para la tabla `dbasesores`
--

CREATE TABLE IF NOT EXISTS `dbasesores` (
`idasesor` int(11) NOT NULL,
  ...
  `ine` varchar(18) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `telefonomovil` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
  `telefonocasa` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
  `telefonotrabajo` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
...
`idcliente` int(11) NOT NULL,
  ...
  `refpromotores` int(11) DEFAULT '0',
  `refasesores` int(11) DEFAULT '0',
...
INSERT INTO `dbclientes` (`idcliente`, `nombre`, `apellidopaterno`, `apellidomaterno`, `email`, `sexo`, `refestadocivil`, `rfc`, `curp`, `fechanacimiento`, `numerocliente`, `nacionalidad`, `refpromotores`, `refasesores`, `refrolhogar`, `reftipoclientes`, `refentidadnacimiento`, `refusuarios`, `fechacrea`, `fechamodi`, `usuariocrea`, `usuariomodi`) VALUES
(5, 'Luis Raúl', 'Bello', 'Mena', 'msredhotero@gmail.com', 'M', 1, 'BEML9203138S9', 'BEML920313HMCLNS09', '1992-03-13', 'ASE0000005', 'Mexico', 0, NULL, 1, 1, 15, 4, '2019-09-23 00:00:00', '2019-09-23 00:00:00', 'Web', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dbdocumentacionasesores`
--

CREATE TABLE IF NOT EXISTS `dbdocumentacionasesores` (
`iddocumentacionasesor` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `dbdocumentaciones`
--

CREATE TABLE IF NOT EXISTS `dbdocumentaciones` (
`iddocumentacionsolicitud` int(11) NOT NULL,
  `reftipodocumentaciones` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `dbpostulantes`
--

CREATE TABLE IF NOT EXISTS `dbpostulantes` (
`idpostulante` int(11) NOT NULL,
  `refusuarios` int(11) NOT NULL,
  `nombre` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
  `apellidopaterno` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `apellidomaterno` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  ...
  `telefonocasa` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
  `telefonotrabajo` varchar(12) COLLATE utf8_spanish_ci DEFAULT NULL,
  `refestadopostulante` int(11) NOT NULL,
  `urlprueba` varchar(300) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fechaentrevista` datetime DEFAULT NULL,
  `ciudad` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `entrevistador` varchar(60) COLLATE utf8_spanish_ci DEFAULT NULL,
  `fechacrea` datetime NOT NULL,
  `fechamodi` datetime NOT NULL,
  `usuariocrea` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `usuariomodi` varchar(60) COLLATE utf8_spanish_ci NOT NULL,
  `refasesores` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `tbestadodocumentaciones`
--

CREATE TABLE IF NOT EXISTS `tbestadodocumentaciones` (
`idestadodocumentacion` int(11) NOT NULL,
  `estadodocumentacion` varchar(60) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `tbestadodocumentaciones`
--

INSERT INTO `tbestadodocumentaciones` (`idestadodocumentacion`, `estadodocumentacion`) VALUES
(1, 'Cargada'),
(2, 'Rechazada'),
(3, 'Rechazada - Invalida'),
(4, 'Rechazada - ilegible'),
(5, 'Aceptada');
...
INSERT INTO `tbestadopostulantes` (`idestadopostulante`, `estadopostulante`) VALUES
(1, 'Proceso de Reclutamiento'),
(2, 'Entrevista'),
(3, 'Prueba Psicométricas'),
(4, 'Aceptado'),
(5, 'Rechazado');
...
--
-- Estructura de tabla para la tabla `tbtipodocumentaciones`
--

CREATE TABLE IF NOT EXISTS `tbtipodocumentaciones` (
`idtipodocumentacion` int(11) NOT NULL,
  `tipodocumentacion` varchar(60) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `tbtipodocumentaciones`
--

INSERT INTO `tbtipodocumentaciones` (`idtipodocumentacion`, `tipodocumentacion`) VALUES
(1, 'Solcitudes'),
(2, 'Asesores');
...
--
-- Indices de la tabla `dbasesores`
--
ALTER TABLE `dbasesores`
...
--
-- Indices de la tabla `dbdocumentacionasesores`
--
ALTER TABLE `dbdocumentacionasesores`
 ADD PRIMARY KEY (`iddocumentacionasesor`);

--
-- Indices de la tabla `dbdocumentaciones`
--
ALTER TABLE `dbdocumentaciones`
...
--
-- Indices de la tabla `dbpostulantes`
--
...
--
-- Indices de la tabla `tbestadodocumentaciones`
--
ALTER TABLE `tbestadodocumentaciones`
...
--
-- Indices de la tabla `tbtipodocumentaciones`
--
ALTER TABLE `tbtipodocumentaciones`
 ADD PRIMARY KEY (`idtipodocumentacion`);
...
--
-- AUTO_INCREMENT de la tabla `dbasesores`
--
ALTER TABLE `dbasesores`
...
--
-- AUTO_INCREMENT de la tabla `dbdocumentacionasesores`
--
ALTER TABLE `dbdocumentacionasesores`
MODIFY `iddocumentacionasesor` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `dbdocumentaciones`
--
ALTER TABLE `dbdocumentaciones`
...
MODIFY `iddocumentacionsolicitud` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `dbpostulantes`
--
ALTER TABLE `dbpostulantes`
...
--
-- AUTO_INCREMENT de la tabla `tbestadodocumentaciones`
--
ALTER TABLE `tbestadodocumentaciones`
MODIFY `idestadodocumentacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `tbestadopostulantes`
--
ALTER TABLE `tbestadopostulantes`
MODIFY `idestadopostulante` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6;
--
...
--
-- AUTO_INCREMENT de la tabla `tbtipodocumentaciones`
--
ALTER TABLE `tbtipodocumentaciones`
MODIFY `idtipodocumentacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
